...
If you don't have your version around, you can fork it and clone it from [https://github.com/sebawita/angular-getting-started/](https://github.com/sebawita/angular-getting-started/).
